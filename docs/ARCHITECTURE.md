...
│           ├── schemas.py    # VenueOut, VenueUpdate, DestinationOut, DestinationRef, PublishRevisionOut, PublishedVenueOut
│           └── routes/
...
│               └── publish.py    # POST /publish, GET /published/venues — the first public read path
