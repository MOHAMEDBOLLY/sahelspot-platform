...
│           ├── schemas.py    # VenueOut, VenueUpdate, DestinationOut, DestinationRef, PublishRevisionOut, PublishRevisionDetail, PublishedVenueOut, ActivityLogEntryOut
│           └── routes/
